class Oxford::Ent < Oxford::Oxford
	...
	## here we have to upcase everything.
	def title_processor(line)
		section_name = nil
		line.strip.scan(/^(?<title>[A-Za-z0-9\s]+)$/) do |title|
